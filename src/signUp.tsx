      ...
      <CardContent>
        ...
        >
          ...
          >
            ...
            <Box paddingBottom={2}>
              <Field component={CheckboxWithLabel} type="checkbox" name="acceptedTerms" Label={{ label: "I am millionaire" }} />
            </Box>
          </FormikStep>
            ...
            validationSchema={
              Yup.object({
                money: Yup.number().when("acceptedTerms", {
                  is: true,
                  then: number().required().min(1_000_000,"Because you said you are millionaire you need to have 1 Million"),
                  otherwise: number().required()
                }),
                // age: Yup.number().min(2,"Minimum 2 Members Required").required("required")
              })
            }
          >
            {/* <Box paddingBottom={2}>
            ...
            <Box paddingBottom={2}>
              <Field component={TextField} type="number" name="money" label="All the money I have" />
